...
export default function Checkout() {
  ...
  const [form, setForm] = useState({
    ...
    townCity: '', phoneNumber: '', emailAddress: '', saveInfo: true,
  })
  ...
  if (items.length === 0 && !placed) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        <p className="text-body text-sm mb-6">Your cart is empty — nothing to check out.</p>
        <Button onClick={() => navigate('/')} variant="primary">Return To Shop</Button>
      </div>
    )
  }
  ...
  if (placed) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        <h1 className="font-heading text-2xl font-medium mb-3">Order placed!</h1>
        <p className="text-sm text-body mb-2">Thanks — your order has been received.</p>
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-10">
        ...
        <div>
          ...
          <Button onClick={handlePlaceOrder} variant="primary" size="lg" className="mt-6">
